...
_Auto-generated from registry.json — total 124 skills._

| Skill | Lifecycle | Sync | Tags | GitHub |
| --- | --- | --- | --- | --- |
| `_ref-review-criteria` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/_ref-review-criteria) |
...
| `codebase-design` | `active` | 📝 draft | — | — |
| `company-intel` | `active` | ✅ published | — | [link](https://github.com/joneshong-skills/company-intel) |
| `competitive-intel` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/competitive-intel) |
...
| `fetch-from-air` | `active` | 🔒 local-only | — | — |
...
| `github-pm` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/github-pm) |
| `goal-prompt` | `active` | 🔒 local-only | — | — |
| `grill-me` | `active` | 📝 draft | — | — |
| `grilling` | `active` | 📝 draft | — | — |
...
| `ocr-claude-api` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/ocr-claude-api) |
| `openclaw-mentor` | `active` | ✅ published | — | [link](https://github.com/joneshong-skills/openclaw-mentor) |
| `over-engineering-audit` | `active` | 🔒 local-only | — | — |
...
| `projectagent` | `active` | 🔒 local-only | — | — |
...
| `smart-search` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/smart-search) |
...
| `team-tasks` | `active` | ⚠️ needs-update | — | [link](https://github.com/joneshong-skills/team-tasks) |
...
| `workflow-prompt` | `active` | 🔒 local-only | — | — |
| `writing-great-skills` | `active` | 📝 draft | — | — |
