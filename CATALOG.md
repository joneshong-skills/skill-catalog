...
_Auto-generated from registry.json — total 118 skills._
...
| `agent-hatchery` | `active` | ✅ published | — | 🔒 private |
| `agentctl` | `active` | ✅ published | — | 🔒 private |
| `anvil` | `active` | 📝 draft | — | 🔒 private |
| `blast-radius` | `active` | ✅ published | — | 🔒 private |
...
| `cli-headless` | `active` | ✅ published | — | 🔒 private |
...
| `content-writer` | `active` | 📝 draft | — | [link](https://github.com/joneshong-skills/content-writer) |
| `context-diet` | `active` | 📝 draft | — | [link](https://github.com/joneshong-skills/context-diet) |
| `create-agent` | `active` | 📝 draft | — | [link](https://github.com/joneshong-skills/create-agent) |
| `create-command` | `active` | 📝 draft | — | [link](https://github.com/joneshong-skills/create-command) |
...
| `goal-prompt` | `active` | ✅ published | — | 🔒 private |
| `grill-me` | `active` | ✅ published | — | 🔒 private |
| `grilling` | `active` | ✅ published | — | 🔒 private |
...
| `hyperframes-audio` | `active` | 🔒 local-only | — | — |
| `hyperframes-cli` | `active` | 🔒 local-only | — | — |
| `hyperframes-core` | `active` | 🔒 local-only | — | — |
| `hyperframes-creative` | `active` | 🔒 local-only | — | — |
| `hyperframes-keyframes` | `active` | 🔒 local-only | — | — |
| `hyperframes-registry` | `active` | 🔒 local-only | — | — |
...
| `mjs-prompt` | `active` | ✅ published | — | 🔒 private |
...
| `photo-edit` | `active` | ✅ published | — | 🔒 private |
...
| `show-me-your-work` | `active` | ✅ published | — | 🔒 private |
...
| `writing-great-skills` | `active` | ✅ published | — | 🔒 private |
...
`create-skill`（造）→ `skill-security-scan` / `anvil`（驗：有無 prompt injection／遙測+結構品質評分，兩線並行）→ `skill-optimizer` / `skill-curator` / `skill-lifecycle` / `skill-evolver`（優化，見下 because）→ `skill-publisher`（發布）。旁支：`skill-catalog`（本文件的產出者，也產協作關係圖）、`skill-proxy`（BM25 冷 skill 索引兜底）、`cannibalize`（從外部 repo 吸收新 pattern，是造的上游）。同家不同造物：`create-agent`（造 agent）、`create-command`（造 slash command）、`mcp-builder`（造 MCP server）。
